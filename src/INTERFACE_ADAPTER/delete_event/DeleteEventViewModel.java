...
/**
 * The {@code DeleteEventViewModel} class serves as the view model for the "delete event" functionality.
 * It extends the {@link ViewModel} class and encapsulates the state of the view
...
public class DeleteEventViewModel extends ViewModel {
    ...
    /**
     * Sets the state of the "delete event" form.
     *
    ...
    /**
     * Gets the current state of the "delete event" form.
     *
